...
def wiener_filter_dft(noisy_image, noise_power, signal_power, min_threshold=0.5):
    """
    ...
    Parameters:
        ...
        min_threshold (float): Minimum threshold to the filter
    ...
    filter = np.maximum(filter, min_threshold)
