...
# select the denoise function - uncomment the desired function
...
show_dft(original_image_as_float, 'Original Image FFT')
show_dft(noisy_image_as_float, 'Noisy Image FFT')
show_dft(denoised_image, 'Denoised Image FFT')
show_dft(denoised_image_sota, 'State of the art denoised FFT')
